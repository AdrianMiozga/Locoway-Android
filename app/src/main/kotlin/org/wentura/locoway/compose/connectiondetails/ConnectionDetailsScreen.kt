package org.wentura.locoway.compose.connectiondetails
...
import org.wentura.locoway.compose.common.AddPassengerDialog
...
import org.wentura.locoway.viewmodels.ConnectionDetailsUiState
import org.wentura.locoway.viewmodels.ConnectionDetailsViewModel
            ...
            Column {
                state.passengers.forEachIndexed { index, passenger ->
                    PassengerListItem(
                        index,
                        passenger,
                        state.selectedPassengers[index],
                        onCheckedChange,
                    )
                }
            }
